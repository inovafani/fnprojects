...
const STONES = [
  "#d9d5cb", "#c9c4b8", "#b7b2a4", "#8f9a86", "#5f7a5c",
  "#3c6042", "#1d7549", "#135f38", "#0b4a2b",
];
export function makeDiagSteps() {
  ...
  for (let i = 0; i < N; i++) {
    ...
    const tone = STONES[Math.min(STONES.length - 1, Math.floor(t * STONES.length))];
...
export const services = [
  { no: "01", name: "Kitchens", desc: "Bespoke joinery, stone benchtops and integrated appliances, detailed to millimetre tolerances." },
  { no: "02", name: "Bathrooms", desc: "Calm, waterproofed-right ensuites and family bathrooms with considered tiling and tapware." },
  { no: "03", name: "Full renovations", desc: "Whole-home transformations managed end to end, from first sketch to final handover." },
  { no: "04", name: "Outdoor living", desc: "Pavilions, decks and alfresco spaces that extend the home into the garden." },
  { no: "05", name: "Custom builds", desc: "Ground-up new homes built to architectural drawings and finished without compromise." },
];
...
export const projects = [
  ...
  },
  {
    ...
    desc: "Warm walnut joinery and a split-stone splashback open directly onto the garden.",
    img: "/projects/web/kitchen2.jpg",
  },
  {
  ...
  {
    title: "Galley Chef's Kitchen",
    category: "Kitchen",
    location: "Killara, NSW",
    desc: "A streamlined galley layout with professional appliances and honed stone benchtops.",
    img: "/projects/web/kitchen3.jpg",
  },
  {
    title: "Cellar & Dining",
    category: "Dining",
...
export const testimonials = [
  { quote: "They finished our renovation on time and it looks better than we imagined.", name: "Sarah & Michael T.", project: "Full home renovation, Manly", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80" },
  { quote: "The detailing in the kitchen joinery is faultless. Genuinely craftsman-level work.", name: "James P.", project: "Kitchen renovation, Bondi", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200&q=80" },
  { quote: "Calm, communicative and precise from first sketch to handover. We'd build with them again.", name: "Priya & Dan R.", project: "Custom build, Avalon", avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80" },
];

export const footerServices = ["Kitchens", "Bathrooms", "Full renovations", "Outdoor living", "Custom builds"];

export const stats = [
  { value: 20, suffix: " yrs", label: "Building across Sydney" },
